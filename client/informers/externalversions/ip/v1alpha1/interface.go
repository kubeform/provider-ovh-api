...
type Interface interface {
	// Reverses returns a ReverseInformer.
	Reverses() ReverseInformer
...
// Reverses returns a ReverseInformer.
func (v *version) Reverses() ReverseInformer {
	return &reverseInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
