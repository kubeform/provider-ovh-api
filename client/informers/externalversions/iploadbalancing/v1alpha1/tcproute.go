	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.IploadbalancingV1alpha1().TcpRoutes(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.IploadbalancingV1alpha1().TcpRoutes(namespace).Watch(context.TODO(), options)
			},
		},
		&iploadbalancingv1alpha1.TcpRoute{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *tcpRouteInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&iploadbalancingv1alpha1.TcpRoute{}, f.defaultInformer)
}
