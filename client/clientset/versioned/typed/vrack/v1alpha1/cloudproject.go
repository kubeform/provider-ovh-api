...
// CloudprojectsGetter has a method to return a CloudprojectInterface.
...
// cloudprojects implements CloudprojectInterface
type cloudprojects struct {
	client rest.Interface
	ns     string
}

// newCloudprojects returns a Cloudprojects
func newCloudprojects(c *VrackV1alpha1Client, namespace string) *cloudprojects {
...
func (c *cloudprojects) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Cloudproject, err error) {
	result = &v1alpha1.Cloudproject{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *cloudprojects) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CloudprojectList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.CloudprojectList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("cloudprojects").
...
func (c *cloudprojects) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *cloudprojects) Create(ctx context.Context, cloudproject *v1alpha1.Cloudproject, opts v1.CreateOptions) (result *v1alpha1.Cloudproject, err error) {
	result = &v1alpha1.Cloudproject{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cloudprojects").
...
func (c *cloudprojects) Update(ctx context.Context, cloudproject *v1alpha1.Cloudproject, opts v1.UpdateOptions) (result *v1alpha1.Cloudproject, err error) {
	result = &v1alpha1.Cloudproject{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cloudprojects").
...
func (c *cloudprojects) UpdateStatus(ctx context.Context, cloudproject *v1alpha1.Cloudproject, opts v1.UpdateOptions) (result *v1alpha1.Cloudproject, err error) {
	result = &v1alpha1.Cloudproject{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cloudprojects").
...
func (c *cloudprojects) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *cloudprojects) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *cloudprojects) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Cloudproject, err error) {
	result = &v1alpha1.Cloudproject{}
