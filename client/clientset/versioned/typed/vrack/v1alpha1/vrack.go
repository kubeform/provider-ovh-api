...
// VracksGetter has a method to return a VrackInterface.
...
// vracks implements VrackInterface
type vracks struct {
	client rest.Interface
	ns     string
}

// newVracks returns a Vracks
func newVracks(c *VrackV1alpha1Client, namespace string) *vracks {
	return &vracks{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *vracks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Vrack, err error) {
	result = &v1alpha1.Vrack{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("vracks").
		Name(name).
...
func (c *vracks) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.VrackList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.VrackList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("vracks").
...
func (c *vracks) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *vracks) Create(ctx context.Context, vrack *v1alpha1.Vrack, opts v1.CreateOptions) (result *v1alpha1.Vrack, err error) {
	result = &v1alpha1.Vrack{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("vracks").
...
func (c *vracks) Update(ctx context.Context, vrack *v1alpha1.Vrack, opts v1.UpdateOptions) (result *v1alpha1.Vrack, err error) {
	result = &v1alpha1.Vrack{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("vracks").
...
func (c *vracks) UpdateStatus(ctx context.Context, vrack *v1alpha1.Vrack, opts v1.UpdateOptions) (result *v1alpha1.Vrack, err error) {
	result = &v1alpha1.Vrack{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("vracks").
...
func (c *vracks) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *vracks) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *vracks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Vrack, err error) {
	result = &v1alpha1.Vrack{}
