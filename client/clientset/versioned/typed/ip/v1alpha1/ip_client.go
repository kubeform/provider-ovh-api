...
// IpV1alpha1Client is used to interact with features provided by the ip.ovh.kubeform.com group.
type IpV1alpha1Client struct {
	restClient rest.Interface
}

func (c *IpV1alpha1Client) Reverses(namespace string) ReverseInterface {
	return newReverses(c, namespace)
}

func (c *IpV1alpha1Client) Services(namespace string) ServiceInterface {
