...
var zonesResource = schema.GroupVersionResource{Group: "domain.ovh.kubeform.com", Version: "v1alpha1", Resource: "zones"}

var zonesKind = schema.GroupVersionKind{Group: "domain.ovh.kubeform.com", Version: "v1alpha1", Kind: "Zone"}
