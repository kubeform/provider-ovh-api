...
// ProjectContainerregistriesGetter has a method to return a ProjectContainerregistryInterface.
...
// projectContainerregistries implements ProjectContainerregistryInterface
type projectContainerregistries struct {
	client rest.Interface
	ns     string
}

// newProjectContainerregistries returns a ProjectContainerregistries
func newProjectContainerregistries(c *CloudV1alpha1Client, namespace string) *projectContainerregistries {
	return &projectContainerregistries{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *projectContainerregistries) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ProjectContainerregistry, err error) {
	result = &v1alpha1.ProjectContainerregistry{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *projectContainerregistries) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ProjectContainerregistryList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ProjectContainerregistryList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("projectcontainerregistries").
...
func (c *projectContainerregistries) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *projectContainerregistries) Create(ctx context.Context, projectContainerregistry *v1alpha1.ProjectContainerregistry, opts v1.CreateOptions) (result *v1alpha1.ProjectContainerregistry, err error) {
	result = &v1alpha1.ProjectContainerregistry{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("projectcontainerregistries").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(projectContainerregistry).
		Do(ctx).
		Into(result)
	return
}
...
func (c *projectContainerregistries) Update(ctx context.Context, projectContainerregistry *v1alpha1.ProjectContainerregistry, opts v1.UpdateOptions) (result *v1alpha1.ProjectContainerregistry, err error) {
	result = &v1alpha1.ProjectContainerregistry{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("projectcontainerregistries").
		Name(projectContainerregistry.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(projectContainerregistry).
		Do(ctx).
		Into(result)
...
func (c *projectContainerregistries) UpdateStatus(ctx context.Context, projectContainerregistry *v1alpha1.ProjectContainerregistry, opts v1.UpdateOptions) (result *v1alpha1.ProjectContainerregistry, err error) {
	result = &v1alpha1.ProjectContainerregistry{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("projectcontainerregistries").
...
func (c *projectContainerregistries) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *projectContainerregistries) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *projectContainerregistries) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ProjectContainerregistry, err error) {
	result = &v1alpha1.ProjectContainerregistry{}
