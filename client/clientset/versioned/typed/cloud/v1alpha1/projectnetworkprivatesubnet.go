...
// ProjectNetworkPrivateSubnetsGetter has a method to return a ProjectNetworkPrivateSubnetInterface.
...
// projectNetworkPrivateSubnets implements ProjectNetworkPrivateSubnetInterface
type projectNetworkPrivateSubnets struct {
	client rest.Interface
	ns     string
}

// newProjectNetworkPrivateSubnets returns a ProjectNetworkPrivateSubnets
func newProjectNetworkPrivateSubnets(c *CloudV1alpha1Client, namespace string) *projectNetworkPrivateSubnets {
	return &projectNetworkPrivateSubnets{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *projectNetworkPrivateSubnets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ProjectNetworkPrivateSubnet, err error) {
	result = &v1alpha1.ProjectNetworkPrivateSubnet{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *projectNetworkPrivateSubnets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ProjectNetworkPrivateSubnetList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ProjectNetworkPrivateSubnetList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("projectnetworkprivatesubnets").
...
func (c *projectNetworkPrivateSubnets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *projectNetworkPrivateSubnets) Create(ctx context.Context, projectNetworkPrivateSubnet *v1alpha1.ProjectNetworkPrivateSubnet, opts v1.CreateOptions) (result *v1alpha1.ProjectNetworkPrivateSubnet, err error) {
	result = &v1alpha1.ProjectNetworkPrivateSubnet{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("projectnetworkprivatesubnets").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(projectNetworkPrivateSubnet).
		Do(ctx).
		Into(result)
	return
}
...
func (c *projectNetworkPrivateSubnets) Update(ctx context.Context, projectNetworkPrivateSubnet *v1alpha1.ProjectNetworkPrivateSubnet, opts v1.UpdateOptions) (result *v1alpha1.ProjectNetworkPrivateSubnet, err error) {
	result = &v1alpha1.ProjectNetworkPrivateSubnet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("projectnetworkprivatesubnets").
		Name(projectNetworkPrivateSubnet.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(projectNetworkPrivateSubnet).
		Do(ctx).
		Into(result)
...
func (c *projectNetworkPrivateSubnets) UpdateStatus(ctx context.Context, projectNetworkPrivateSubnet *v1alpha1.ProjectNetworkPrivateSubnet, opts v1.UpdateOptions) (result *v1alpha1.ProjectNetworkPrivateSubnet, err error) {
	result = &v1alpha1.ProjectNetworkPrivateSubnet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("projectnetworkprivatesubnets").
...
func (c *projectNetworkPrivateSubnets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *projectNetworkPrivateSubnets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *projectNetworkPrivateSubnets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ProjectNetworkPrivateSubnet, err error) {
	result = &v1alpha1.ProjectNetworkPrivateSubnet{}
