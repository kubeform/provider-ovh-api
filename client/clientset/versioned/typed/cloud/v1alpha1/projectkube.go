...
// ProjectKubesGetter has a method to return a ProjectKubeInterface.
...
// projectKubes implements ProjectKubeInterface
type projectKubes struct {
	client rest.Interface
	ns     string
}

// newProjectKubes returns a ProjectKubes
func newProjectKubes(c *CloudV1alpha1Client, namespace string) *projectKubes {
	return &projectKubes{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *projectKubes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ProjectKube, err error) {
	result = &v1alpha1.ProjectKube{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *projectKubes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ProjectKubeList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ProjectKubeList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("projectkubes").
...
func (c *projectKubes) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *projectKubes) Create(ctx context.Context, projectKube *v1alpha1.ProjectKube, opts v1.CreateOptions) (result *v1alpha1.ProjectKube, err error) {
	result = &v1alpha1.ProjectKube{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("projectkubes").
...
func (c *projectKubes) Update(ctx context.Context, projectKube *v1alpha1.ProjectKube, opts v1.UpdateOptions) (result *v1alpha1.ProjectKube, err error) {
	result = &v1alpha1.ProjectKube{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("projectkubes").
		Name(projectKube.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(projectKube).
		Do(ctx).
		Into(result)
...
func (c *projectKubes) UpdateStatus(ctx context.Context, projectKube *v1alpha1.ProjectKube, opts v1.UpdateOptions) (result *v1alpha1.ProjectKube, err error) {
	result = &v1alpha1.ProjectKube{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("projectkubes").
...
func (c *projectKubes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *projectKubes) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *projectKubes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ProjectKube, err error) {
	result = &v1alpha1.ProjectKube{}
