...
// ProjectUsersGetter has a method to return a ProjectUserInterface.
...
// projectUsers implements ProjectUserInterface
type projectUsers struct {
	client rest.Interface
	ns     string
}

// newProjectUsers returns a ProjectUsers
func newProjectUsers(c *CloudV1alpha1Client, namespace string) *projectUsers {
	return &projectUsers{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *projectUsers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ProjectUser, err error) {
	result = &v1alpha1.ProjectUser{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *projectUsers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ProjectUserList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ProjectUserList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("projectusers").
...
func (c *projectUsers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *projectUsers) Create(ctx context.Context, projectUser *v1alpha1.ProjectUser, opts v1.CreateOptions) (result *v1alpha1.ProjectUser, err error) {
	result = &v1alpha1.ProjectUser{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("projectusers").
...
func (c *projectUsers) Update(ctx context.Context, projectUser *v1alpha1.ProjectUser, opts v1.UpdateOptions) (result *v1alpha1.ProjectUser, err error) {
	result = &v1alpha1.ProjectUser{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("projectusers").
...
func (c *projectUsers) UpdateStatus(ctx context.Context, projectUser *v1alpha1.ProjectUser, opts v1.UpdateOptions) (result *v1alpha1.ProjectUser, err error) {
	result = &v1alpha1.ProjectUser{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("projectusers").
...
func (c *projectUsers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *projectUsers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *projectUsers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ProjectUser, err error) {
	result = &v1alpha1.ProjectUser{}
