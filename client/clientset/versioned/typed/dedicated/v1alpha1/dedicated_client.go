...
type DedicatedV1alpha1Interface interface {
	RESTClient() rest.Interface
	CephACLsGetter
	ServerInstallTasksGetter
	ServerRebootTasksGetter
	ServerUpdatesGetter
}
...
func NewForConfig(c *rest.Config) (*DedicatedV1alpha1Client, error) {
	...
	return &DedicatedV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new DedicatedV1alpha1Client for the given config and
...
func New(c rest.Interface) *DedicatedV1alpha1Client {
	return &DedicatedV1alpha1Client{c}
}
