...
// HttpFarmsGetter has a method to return a HttpFarmInterface.
...
// httpFarms implements HttpFarmInterface
type httpFarms struct {
	client rest.Interface
	ns     string
}

// newHttpFarms returns a HttpFarms
func newHttpFarms(c *IploadbalancingV1alpha1Client, namespace string) *httpFarms {
	return &httpFarms{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *httpFarms) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.HttpFarm, err error) {
	result = &v1alpha1.HttpFarm{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("httpfarms").
		Name(name).
...
func (c *httpFarms) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.HttpFarmList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.HttpFarmList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("httpfarms").
...
func (c *httpFarms) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *httpFarms) Create(ctx context.Context, httpFarm *v1alpha1.HttpFarm, opts v1.CreateOptions) (result *v1alpha1.HttpFarm, err error) {
	result = &v1alpha1.HttpFarm{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("httpfarms").
...
func (c *httpFarms) Update(ctx context.Context, httpFarm *v1alpha1.HttpFarm, opts v1.UpdateOptions) (result *v1alpha1.HttpFarm, err error) {
	result = &v1alpha1.HttpFarm{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("httpfarms").
...
func (c *httpFarms) UpdateStatus(ctx context.Context, httpFarm *v1alpha1.HttpFarm, opts v1.UpdateOptions) (result *v1alpha1.HttpFarm, err error) {
	result = &v1alpha1.HttpFarm{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("httpfarms").
...
func (c *httpFarms) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *httpFarms) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *httpFarms) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.HttpFarm, err error) {
	result = &v1alpha1.HttpFarm{}
