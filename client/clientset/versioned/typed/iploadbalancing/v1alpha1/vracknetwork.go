...
// VrackNetworksGetter has a method to return a VrackNetworkInterface.
...
// vrackNetworks implements VrackNetworkInterface
type vrackNetworks struct {
	client rest.Interface
	ns     string
}

// newVrackNetworks returns a VrackNetworks
func newVrackNetworks(c *IploadbalancingV1alpha1Client, namespace string) *vrackNetworks {
	return &vrackNetworks{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *vrackNetworks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.VrackNetwork, err error) {
	result = &v1alpha1.VrackNetwork{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *vrackNetworks) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.VrackNetworkList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.VrackNetworkList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("vracknetworks").
...
func (c *vrackNetworks) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *vrackNetworks) Create(ctx context.Context, vrackNetwork *v1alpha1.VrackNetwork, opts v1.CreateOptions) (result *v1alpha1.VrackNetwork, err error) {
	result = &v1alpha1.VrackNetwork{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("vracknetworks").
...
func (c *vrackNetworks) Update(ctx context.Context, vrackNetwork *v1alpha1.VrackNetwork, opts v1.UpdateOptions) (result *v1alpha1.VrackNetwork, err error) {
	result = &v1alpha1.VrackNetwork{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("vracknetworks").
		Name(vrackNetwork.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(vrackNetwork).
		Do(ctx).
		Into(result)
...
func (c *vrackNetworks) UpdateStatus(ctx context.Context, vrackNetwork *v1alpha1.VrackNetwork, opts v1.UpdateOptions) (result *v1alpha1.VrackNetwork, err error) {
	result = &v1alpha1.VrackNetwork{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("vracknetworks").
...
func (c *vrackNetworks) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *vrackNetworks) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *vrackNetworks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.VrackNetwork, err error) {
	result = &v1alpha1.VrackNetwork{}
