...
// HttpFarmServersGetter has a method to return a HttpFarmServerInterface.
...
// httpFarmServers implements HttpFarmServerInterface
type httpFarmServers struct {
	client rest.Interface
	ns     string
}

// newHttpFarmServers returns a HttpFarmServers
func newHttpFarmServers(c *IploadbalancingV1alpha1Client, namespace string) *httpFarmServers {
	return &httpFarmServers{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *httpFarmServers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.HttpFarmServer, err error) {
	result = &v1alpha1.HttpFarmServer{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *httpFarmServers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.HttpFarmServerList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.HttpFarmServerList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("httpfarmservers").
...
func (c *httpFarmServers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *httpFarmServers) Create(ctx context.Context, httpFarmServer *v1alpha1.HttpFarmServer, opts v1.CreateOptions) (result *v1alpha1.HttpFarmServer, err error) {
	result = &v1alpha1.HttpFarmServer{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("httpfarmservers").
...
func (c *httpFarmServers) Update(ctx context.Context, httpFarmServer *v1alpha1.HttpFarmServer, opts v1.UpdateOptions) (result *v1alpha1.HttpFarmServer, err error) {
	result = &v1alpha1.HttpFarmServer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("httpfarmservers").
		Name(httpFarmServer.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(httpFarmServer).
		Do(ctx).
		Into(result)
...
func (c *httpFarmServers) UpdateStatus(ctx context.Context, httpFarmServer *v1alpha1.HttpFarmServer, opts v1.UpdateOptions) (result *v1alpha1.HttpFarmServer, err error) {
	result = &v1alpha1.HttpFarmServer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("httpfarmservers").
...
func (c *httpFarmServers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *httpFarmServers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *httpFarmServers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.HttpFarmServer, err error) {
	result = &v1alpha1.HttpFarmServer{}
