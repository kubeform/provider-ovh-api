...
// HttpFrontendsGetter has a method to return a HttpFrontendInterface.
...
// httpFrontends implements HttpFrontendInterface
type httpFrontends struct {
	client rest.Interface
	ns     string
}

// newHttpFrontends returns a HttpFrontends
func newHttpFrontends(c *IploadbalancingV1alpha1Client, namespace string) *httpFrontends {
	return &httpFrontends{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *httpFrontends) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.HttpFrontend, err error) {
	result = &v1alpha1.HttpFrontend{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *httpFrontends) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.HttpFrontendList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.HttpFrontendList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("httpfrontends").
...
func (c *httpFrontends) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *httpFrontends) Create(ctx context.Context, httpFrontend *v1alpha1.HttpFrontend, opts v1.CreateOptions) (result *v1alpha1.HttpFrontend, err error) {
	result = &v1alpha1.HttpFrontend{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("httpfrontends").
...
func (c *httpFrontends) Update(ctx context.Context, httpFrontend *v1alpha1.HttpFrontend, opts v1.UpdateOptions) (result *v1alpha1.HttpFrontend, err error) {
	result = &v1alpha1.HttpFrontend{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("httpfrontends").
		Name(httpFrontend.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(httpFrontend).
		Do(ctx).
		Into(result)
...
func (c *httpFrontends) UpdateStatus(ctx context.Context, httpFrontend *v1alpha1.HttpFrontend, opts v1.UpdateOptions) (result *v1alpha1.HttpFrontend, err error) {
	result = &v1alpha1.HttpFrontend{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("httpfrontends").
...
func (c *httpFrontends) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *httpFrontends) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *httpFrontends) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.HttpFrontend, err error) {
	result = &v1alpha1.HttpFrontend{}
