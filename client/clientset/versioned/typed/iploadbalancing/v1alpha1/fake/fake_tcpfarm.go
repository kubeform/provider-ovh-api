...
var tcpfarmsResource = schema.GroupVersionResource{Group: "iploadbalancing.ovh.kubeform.com", Version: "v1alpha1", Resource: "tcpfarms"}

var tcpfarmsKind = schema.GroupVersionKind{Group: "iploadbalancing.ovh.kubeform.com", Version: "v1alpha1", Kind: "TcpFarm"}
...
func (c *FakeTcpFarms) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TcpFarm, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(tcpfarmsResource, c.ns, name), &v1alpha1.TcpFarm{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.TcpFarm), err
}
...
func (c *FakeTcpFarms) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TcpFarmList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(tcpfarmsResource, tcpfarmsKind, c.ns, opts), &v1alpha1.TcpFarmList{})
	...
	list := &v1alpha1.TcpFarmList{ListMeta: obj.(*v1alpha1.TcpFarmList).ListMeta}
	for _, item := range obj.(*v1alpha1.TcpFarmList).Items {
...
func (c *FakeTcpFarms) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(tcpfarmsResource, c.ns, opts))
...
func (c *FakeTcpFarms) Create(ctx context.Context, tcpFarm *v1alpha1.TcpFarm, opts v1.CreateOptions) (result *v1alpha1.TcpFarm, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(tcpfarmsResource, c.ns, tcpFarm), &v1alpha1.TcpFarm{})
...
func (c *FakeTcpFarms) Update(ctx context.Context, tcpFarm *v1alpha1.TcpFarm, opts v1.UpdateOptions) (result *v1alpha1.TcpFarm, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(tcpfarmsResource, c.ns, tcpFarm), &v1alpha1.TcpFarm{})
...
func (c *FakeTcpFarms) UpdateStatus(ctx context.Context, tcpFarm *v1alpha1.TcpFarm, opts v1.UpdateOptions) (*v1alpha1.TcpFarm, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(tcpfarmsResource, "status", c.ns, tcpFarm), &v1alpha1.TcpFarm{})
...
func (c *FakeTcpFarms) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(tcpfarmsResource, c.ns, name), &v1alpha1.TcpFarm{})
...
func (c *FakeTcpFarms) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(tcpfarmsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.TcpFarmList{})
	return err
}
...
func (c *FakeTcpFarms) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TcpFarm, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(tcpfarmsResource, c.ns, name, pt, data, subresources...), &v1alpha1.TcpFarm{})
