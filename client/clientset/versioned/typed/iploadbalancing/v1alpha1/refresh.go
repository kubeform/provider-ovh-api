...
func newRefreshes(c *IploadbalancingV1alpha1Client, namespace string) *refreshes {
	return &refreshes{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *refreshes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Refresh, err error) {
...
func (c *refreshes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.RefreshList, err error) {
...
func (c *refreshes) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *refreshes) Create(ctx context.Context, refresh *v1alpha1.Refresh, opts v1.CreateOptions) (result *v1alpha1.Refresh, err error) {
	result = &v1alpha1.Refresh{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("refreshes").
...
func (c *refreshes) Update(ctx context.Context, refresh *v1alpha1.Refresh, opts v1.UpdateOptions) (result *v1alpha1.Refresh, err error) {
	result = &v1alpha1.Refresh{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("refreshes").
...
func (c *refreshes) UpdateStatus(ctx context.Context, refresh *v1alpha1.Refresh, opts v1.UpdateOptions) (result *v1alpha1.Refresh, err error) {
	result = &v1alpha1.Refresh{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("refreshes").
...
func (c *refreshes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *refreshes) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *refreshes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Refresh, err error) {
	result = &v1alpha1.Refresh{}
